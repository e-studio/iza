<div class="container">
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-header"><h3>Login Panel</h3></div>
      <div class="card-body">
        <form id="login-form" name="login-form" class="nobottommargin" method="post" onsubmit="return validarIngreso()">

        	<div class="col_full">
				<label for="login-form-username">User:</label>
				<input required="true" type="text" id="usuarioIngreso" name="usuarioIngreso" placeholder="Type your user"  class="form-control not-dark" />
			</div>

			<div class="col_full">
				<label for="login-form-password">Password:</label>
				<input required type="password" id="passwordIngreso" name="passwordIngreso" placeholder="Type your password" value="" class="form-control not-dark" required="true" />
			</div>
